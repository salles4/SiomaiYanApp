...
public class DetailsPage extends javax.swing.JFrame {
    ...
    private void setDetails(){
        user.setText(accDetails.username);
        accnum.setText(String.valueOf(accDetails.accnumber));
        if(accDetails.admin){
            admin.setText("Admin");
        }else{
            admin.setText("Employee");
        }
    }
    public void setProductDetails(){
        stock.setText(stockAmt+"");
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Seller Details"));
        ...
        prodName.setText("somesome");

        jLabel5.setText("Stock:");

        stock.setText("missing");
